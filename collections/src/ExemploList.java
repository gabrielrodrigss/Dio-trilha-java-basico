...
public class ExemploList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Mostre a primeira nota da lista sem remove-lo: " + notas2.get(0));
        

        System.out.println("Mostre a primeira nota da lista removendo-o: " + notas2.get(0) );
        notas2.remove(0);
